...
- [ ] セクション 1: ドメインモデル設計（2問）
- [ ] セクション 2: GameEngine 設計（3問）
- [ ] セクション 3: DoboDeclaration 設計（4問）
- [ ] セクション 4: MultiplierCalculator 設計（3問）
- [ ] セクション 5: DeckManager 設計（4問）
- [ ] セクション 6: ビジネスルール実装（3問）
- [ ] セクション 7: エラーハンドリング（3問）
- [ ] セクション 8: テスト戦略（3問）

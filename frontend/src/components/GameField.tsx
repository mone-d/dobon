      ...
      <div className="flex items-center justify-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            {/* 引けるインジケーター */}
            {onDrawCard && (
              <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-green-500 border-2 border-green-300 flex items-center justify-center shadow-lg animate-bounce">
